...
reload("noah.options")
reload("noah.keymaps")
reload("noah.autocommands")
reload("noah.lsp")
reload("noah.catppuccin")
reload("noah.telescope")
reload("noah.treesitter")
reload("noah.lualine")
reload("noah.lsp-signature")
reload("noah.lightbulb")
-- reload("noah.lsp-inlayhints")
reload("noah.cmp")
reload("noah.dial")
reload("noah.persisted")
reload("noah.dressing")
reload("noah.tmux")
reload("noah.leap")
reload("noah.flit")
reload("noah.typescript-tools")
-- reload("noah.fidget")
reload("noah.copilot")
reload("noah.neoclip")
-- reload("noah.scrollbar")
reload("noah.colorizer")
reload("noah.flote")
reload("noah.bqf")
-- reload("noah.zen-mode")
--[[
